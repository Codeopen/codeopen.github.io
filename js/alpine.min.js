(() => {
    ...
    function Ot(e) {
        w = e.reactive, U = e.release, M = t => e.effect(t, {
            scheduler: r => {
                Be ? St(r) : r()
            }
        }), Ve = e.raw
    ...
    function qr() {
        ee = ee.concat(We.takeRecords()), ee.length && !Je && (Je = !0, queueMicrotask(() => {
            Wr(), Je = !1
        }))
    }
    ...
    function ge(e, t = () => {}) {
        let r = {
            ...
            _x_interceptor: !0,
            initialize(n, i, o) {
                return e(this.initialValue, () => Gr(n, i), s => Xe(n, i, s), i, o)
            }
        };
        return t(r), n => {
...
`:""}`, t), setTimeout(() => {
    ...
    function Jr(e, t, r) {
        ...
        return (i = () => {}, {
            ...
            if (typeof n == "function") {
                ...
                n.finished ? _e(i, n.result, a, s, r) : c.then(l => {
                    _e(i, l, a, s, r)
                }).catch(l => G(l, r, t))
            }
        }
    ...
    function _e(e, t, r, n, i) {
        if (typeof t == "function") {
            let o = t.apply(r, n);
            o instanceof Promise ? o.then(s => _e(e, s, r, n)).catch(s => G(s, i, t)) : e(o)
        } else e(t)
    }
    var rt = "x-";
    ...
    function re(e, t, r) {
        let n = {};
        return Array.from(t).map(Bt((o, s) => n[o] = s)).filter(Ht).map(Xr(n, r)).sort(en).map(o => Qr(e, o))
    }

    function qt(e) {
        return Array.from(e).map(Bt()).filter(t => !Ht(t))
    }
    var nt = !1,
        ne = new Map,
        Ut = Symbol();
    ...
    function Qt() {
        document.body || we("Unable to initialize. Trying to load Alpine before `<body>` is available. Did you forget to add `defer` in Alpine's `<script>` tag?"), K(document, "alpine:init"), K(document, "alpine:initializing"), Ye(), Nt(t => O(t, D)), kt(t => J(() => tn(t))), Dt((t, r) => {
            re(t, r).forEach(n => n())
        });
    ...
    function ie(e, t) {
        return Array.isArray(t) ? nr(e, t.join(" ")) : typeof t == "object" && t !== null ? rn(e, t) : typeof t == "function" ? ie(e, t()) : nr(e, t)
    }
    ...
    function cr(e, t) {
        ...
        V[e] = t, typeof t == "object" && t !== null && t.hasOwnProperty("init") && typeof t.init == "function" && V[e].init(), he(V[e])
    }
    ...
    function ur(e, t) {
        t._x_dataStack = e._x_dataStack, ct = !0, fn(() => {
            un(t)
        }), ct = !1
    }
    ...
    function pr(e, t) {
        return Object.entries(fr).forEach(([r, n]) => {
            Object.defineProperty(e, r, {
                get() {
                    return (...i) => n.bind(t)(...i)
                },
    ...
    var gn = Object.prototype.toString,
        hr = e => gn.call(e),
        ft = e => hr(e).slice(8, -1);
    var Ce = e => hn(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e;
    var Re = e => {
    ...
    var Sn = lt("__proto__,__v_isRef,__isVue"),
        br = new Set(Object.getOwnPropertyNames(Symbol).map(e => Symbol[e]).filter(Te)),
        An = Me(),
        On = Me(!1, !0),
        Tn = Me(!0),
        Cn = Me(!0, !0),
    ...
    function $e(e, t) {
        return function(n, i) {
            let o = this,
                ...
                a = g(s),
                c = t ? bt : e ? xt : yt;
            return !e && E(a, "iterate", B), s.forEach((l, u) => n.call(i, c(l), c(u), o))
        }
    }
    ...
    function Fe(e, t) {
        ...
        return (n, i, o) => i === "__v_isReactive" ? !e : i === "__v_isReadonly" ? e : i === "__v_raw" ? n : Reflect.get(ae(r, i) && i in n ? r : n, i, o)
    }
    var $n = {
            get: Fe(!1, !1)
        },
    ...
    function Vn(e, t) {
        if (e.type === "radio") e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = jr(e.value, t));
        else if (e.type === "checkbox") Number.isInteger(t) ? e.value = t : !Number.isInteger(t) && !Array.isArray(t) && typeof t != "boolean" && ![null, void 0].includes(t) ? e.value = String(t) : Array.isArray(t) ? e.checked = t.some(r => jr(r, e.value)) : e.checked = !!t;
    ...
    function fe(e, t, r, n) {
        let i = e,
            ...
            s = {},
            a = (c, l) => u => l(c, u);
        if (r.includes("dot") && (t = Zn(t)), r.includes("camel") && (t = Qn(t)), r.includes("passive") && (s.passive = !0), r.includes("capture") && (s.capture = !0), r.includes("window") && (i = window), r.includes("document") && (i = document), r.includes("prevent") && (o = a(o, (c, l) => {
    ...
    function ei(e, t) {
        ...
        return r = r.filter(o => !i.includes(o)), !(i.length > 0 && i.filter(s => ((s === "cmd" || s === "super") && (s = "meta"), e[`${s}Key`])).length === i.length && Fr(e.key).includes(r[0]))
    }
    ...
    p("model", (e, {
        ...
        e._x_model = {
            ...
            o(y => {
                y === void 0 && r.match(/\./) && (y = ""), window.fromModel = !0, h(() => ue(e, "value", y)), delete window.fromModel
            })
        }, n(() => {
    ...
    function oi(e, t, r, n) {
        ...
        n(() => {
            ...
            i(s => {
                ...
                a = a.filter(l => !(typeof l.value == "object" && !Array.isArray(l.value) && l.value !== null));
                let c = qt(a);
                a = a.map(l => c.find(u => u.name === l.name) ? {
                    name: `x-bind:${l.name}`,
                    value: `"${l.value}"`
                } : l), re(e, a, r).map(l => {
    ...
    p("for", (e, {
        ...
        e._x_prevKeys = [], e._x_lookup = {}, r(() => ai(e, i, o, s)), n(() => {
    ...
    function ai(e, t, r, n) {
        let i = s => typeof s == "object" && !Array.isArray(s),
            o = e;
        r(s => {
            li(s) && s >= 0 && (s = Array.from(Array(s).keys(), f => f + 1)), s === void 0 && (s = []);
            let a = e._x_lookup,
                c = e._x_prevKeys,
                l = [],
                u = [];
            ...
            for (let f = 0; f < y.length; f++) {
                let [_, x] = y[f], R = a[_], k = a[x], q = document.createElement("div");
                h(() => {
                    k.after(q), R.after(k), q.before(R), q.remove()
                }), Qe(k, l[u.indexOf(x)])
            }
            for (let f = 0; f < d.length; f++) {
                let [_, x] = d[f], R = _ === "template" ? o : a[_], k = l[x], q = u[x], pe = document.importNode(o.content, !0).firstElementChild;
                W(pe, w(k), o), h(() => {
                    R.after(pe), O(pe)
                }), typeof q == "object" && we("x-for key cannot be an object, it must be a string or an integer", o), a[q] = pe
            }
